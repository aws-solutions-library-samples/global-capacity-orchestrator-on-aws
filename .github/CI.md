...
4. **A wiki badge** — a static shields.io badge linking to the Pages site root, where `pages.yml` serves the MkDocs wiki. It sits last on its row so the dynamic quality signals stay grouped.
