...
- **Significant decisions get an ADR** — when a choice is expensive to
  ...
  [Architecture Decision Records](https://github.com/aws-solutions-library-samples/global-capacity-orchestrator-on-aws/tree/main/docs/adr).
...
Use the structured
[issue templates](https://github.com/aws-solutions-library-samples/global-capacity-orchestrator-on-aws/tree/main/.github/ISSUE_TEMPLATE):
...
The project ships a
[Code of Conduct](https://github.com/aws-solutions-library-samples/global-capacity-orchestrator-on-aws/blob/main/CODE_OF_CONDUCT.md)
and records its debts of gratitude in
[ACKNOWLEDGMENTS.md](https://github.com/aws-solutions-library-samples/global-capacity-orchestrator-on-aws/blob/main/ACKNOWLEDGMENTS.md).
