...
- [`gco/`](https://github.com/aws-solutions-library-samples/global-capacity-orchestrator-on-aws/blob/main/gco/README.md)
  ...
  inference proxy).
- [`lambda/`](https://github.com/aws-solutions-library-samples/global-capacity-orchestrator-on-aws/blob/main/lambda/README.md)
  ...
  by the CDK stacks.
- [`dockerfiles/`](https://github.com/aws-solutions-library-samples/global-capacity-orchestrator-on-aws/blob/main/dockerfiles/README.md)
...
- [`cli/`](https://github.com/aws-solutions-library-samples/global-capacity-orchestrator-on-aws/blob/main/cli/README.md)
...
- [`gco_mcp/`](https://github.com/aws-solutions-library-samples/global-capacity-orchestrator-on-aws/blob/main/gco_mcp/README.md)
...
- [`docs/`](https://github.com/aws-solutions-library-samples/global-capacity-orchestrator-on-aws/blob/main/docs/README.md)
...
- [`images/`](https://github.com/aws-solutions-library-samples/global-capacity-orchestrator-on-aws/blob/main/images/README.md)
  — screenshots and visual assets (this wiki serves them too).

## The engineering scaffolding

- [`tests/`](https://github.com/aws-solutions-library-samples/global-capacity-orchestrator-on-aws/blob/main/tests/README.md)
  — the pytest + BATS suite, organized by component; every test module is
  registered and described in its README.
- [`scripts/`](https://github.com/aws-solutions-library-samples/global-capacity-orchestrator-on-aws/blob/main/scripts/README.md)
  — utility scripts for development, testing, and operations (CI-only
  scripts live under `.github/scripts/`).
- [`.github/`](https://github.com/aws-solutions-library-samples/global-capacity-orchestrator-on-aws/blob/main/.github/CI.md)
...
- [`diagrams/`](https://github.com/aws-solutions-library-samples/global-capacity-orchestrator-on-aws/tree/main/diagrams)
  ...
  and the FastAPI applications so they track reality. The spec sheets — the
  two API Gateways, the in-cluster Gateway and the four services — are this
  wiki's [API reference](api/README.md), whose index embeds a diagram of how
  those surfaces fit together; the interactive Swagger UI consoles live at
