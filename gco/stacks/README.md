...
| `aws_load_balancer_controller_policy.py` | Exact upstream AWS Load Balancer Controller v3.4.2 IAM policy, with partition substitution only at synthesis time |
