...
| [openapi/](openapi/) | Generated OpenAPI documents, one per HTTP service, regenerated by `scripts/generate_openapi.py`; rendered into per-service spec sheets under [`diagrams/api_specs/`](../diagrams/api_specs/README.md) and FastAPI's Swagger UI consoles on the project site |
