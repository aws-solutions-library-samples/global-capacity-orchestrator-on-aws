...
|-----------|--------------|-------------|-------------|----------|
| vLLM | `vllm/vllm-openai:v0.20.1` | 8000 | `/health` | OpenAI-compatible LLM serving |
...
gco inference deploy my-llm -i vllm/vllm-openai:v0.20.1 --gpu-count 1 --capacity-type on-demand
```
